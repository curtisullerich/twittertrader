...
public class Emotes extends Pipe {
	...
	private Pattern smile = Pattern
			.compile("#(^|\\W)(\\>\\:\\]|\\:-\\)|\\:\\)|\\:o\\)|\\:\\]|\\:3|\\:c\\)|\\:\\>|\\=\\]|8\\)|\\=\\)|\\:\\}|\\:\\^\\))($|\\W)#");
	private Pattern laugh = Pattern
			.compile("#(^|\\W)(\\>\\:D|\\:-D|\\:D|8-D|x-D|X-D|\\=-D|\\=D|\\=-3|8-\\)|xD|XD|8D|\\=3)($|\\W)#");
	private Pattern sad = Pattern
			.compile("#(^|\\W)(\\>\\:\\[|\\:-\\(|\\:\\(|\\:-c|\\:c|\\:-\\<|\\:-\\[|\\:\\[|\\:\\{|\\>\\.\\>|\\<\\.\\<|\\>\\.\\<)($|\\W)#");
	private Pattern wink = Pattern
			.compile("#(^|\\W)(\\>;\\]|;-\\)|;\\)|\\*-\\)|\\*\\)|;-\\]|;\\]|;D|;\\^\\))($|\\W)#");
	private Pattern tongue = Pattern
			.compile("#(^|\\W)(\\>\\:P|\\:-P|\\:P|X-P|x-p|\\:-p|\\:p|\\=p|\\:-Þ|\\:Þ|\\:-b|\\:b|\\=p|\\=P|xp|XP|xP|Xp)($|\\W)#");
	private Pattern surprise = Pattern
			.compile("#(^|\\W)(\\>\\:o|\\>\\:O|\\:-O|\\:O|°o°|°O°|\\:O|o_O|o\\.O|8-0)($|\\W)#");
	private Pattern annoyed = Pattern
			.compile("#(^|\\W)(\\>\\:\\\\|\\>\\:/|\\:-/|\\:-\\.|\\:\\\\|\\=/|\\=\\\\|\\:S|\\:\\/)($|\\W)#");
