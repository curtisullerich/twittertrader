...
public class Link2Title extends Pipe {
	...
	/**
	 * This assumes that the carrier still has the Tweet Text STRING in the data field
	 */
	@Override
	public Instance pipe(Instance carrier) {
		 ...
		 * has spaces between each word. That way we can just look at each word, see if it's a link,
