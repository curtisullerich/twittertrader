...
public class Constants {
	...
	public static final SimpleDateFormat PRETTY_SDF = new SimpleDateFormat(
			"yyyy-MM-dd_HH:mm:ss");
	public static final SimpleDateFormat UGLY_SDF = new SimpleDateFormat(
			"yyyyMMddHHmmss");
	public static final SimpleDateFormat FRIENDLY_SDF = new SimpleDateFormat(
			"yyyy-MM-dd_HH.mm.ss");
