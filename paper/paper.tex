...
In some domains, filtering tweets based solely on keywords may be appropriate, but disambiguation remains an interesting natural language processing problem in many cases, particularly when the topic in question is a commonplace (and thus ambiguous) word, such as "apple," "blackberry," "android," or "adobe" (\citeauthor{journals/ijcsa/YervaMA12}). 
