...
\hline
\multicolumn{4}{|c|}{\textbf{Twitter-aware tokenizer}}\\
\hline
\multicolumn{2}{|c|}{\textbf{no stopword removal}} & \multicolumn{2}{|c|}{\textbf{stopword removal}}\\
\hline
\textbf{apple} & \textbf{none}  & \textbf{apple}     & \textbf{none}        \\ \hline
        Apple  & i     & Apple      & apple        \\
...
        for    & new   & my\_iphone & apple\_juice \\ \hline
\end{tabular}
\end{table}
