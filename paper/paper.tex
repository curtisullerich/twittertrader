...
Using machine learning techniques, we analyze the accuracy of classifying whether tweets are part of the public opinion about a particular company or merely contain keywords related to the company.
